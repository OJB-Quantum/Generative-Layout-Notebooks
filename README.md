...
GDSII/OASIS layout generation done completely in Google Colab notebooks. Layout previews are plotted as 2D graphics before exporting. No need to download anything manually, just run the notebook(s).
